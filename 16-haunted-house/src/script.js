...
const floorARMTexture = textureLoader.load(
	"/floor/brown_mud_leaves_01_arm_1k.webp",
);
...
const wallARMTexture = textureLoader.load(
	"/wall/red_brick_plaster_patch_02_arm_1k.webp",
);
const wallColorTexture = textureLoader.load(
	"/wall/red_brick_plaster_patch_02_diff_1k.webp",
);
const wallNormalTexture = textureLoader.load(
	"/wall/red_brick_plaster_patch_02_nor_gl_1k.webp",
);
...
const roofARMTexture = textureLoader.load(
	"/roof/thatch_roof_angled_arm_1k.webp",
);
const roofColorTexture = textureLoader.load(
	"/roof/thatch_roof_angled_diff_1k.webp",
);
const roofNormalTexture = textureLoader.load(
	"/roof/thatch_roof_angled_nor_gl_1k.webp",
);
...
const graveARMTexture = textureLoader.load(
	"/grave/gravel_embedded_concrete_arm_1k.webp",
);
const graveColorTexture = textureLoader.load(
	"/grave/gravel_embedded_concrete_diff_1k.webp",
);
const graveNormalTexture = textureLoader.load(
	"/grave/gravel_embedded_concrete_nor_gl_1k.webp",
);
